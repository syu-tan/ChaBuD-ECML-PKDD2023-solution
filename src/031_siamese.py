...
class CFG(object):
    ...
    info = f'Sia_CAL{use_california}DEF{use_defect}NON{use_non_fold}_'
    # model info
    ...
    # train info
    info += f'_fl-trE{epoch}GA{trainer["accumulate_grad_batches"]}'
