...
class CFG(object):
    ...
    notebook: str = '026_post_model.py'
...
class FireDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        elif row.area in ['tokyo', 'nagoya', 'Arizona', 'Nevata', 'Oregon']:
...
#     # plt.axis('off')
# plt.savefig(os.path.join(cfg.outdir, 'artifact', f'026_image_visualize_tiles_val.png'))
# plt.show();
...
# plt.savefig(os.path.join(cfg.outdir, 'artifact', f'026_mask_visualize_tiles_val.png'))
# plt.show();
...
#     # plt.axis('off')
# plt.savefig(os.path.join(cfg.outdir, 'artifact', f'026_image_visualize_tiles_train.png'))
# plt.show();
...
#     plt.subplot(4, 4, it+1)
#     plt.imshow(mask.numpy())
# plt.savefig(os.path.join(cfg.outdir, 'artifact', f'026_mask_visualize_tiles_train.png'))
# plt.show();
...
for it, img in enumerate(imgs):
    ...
    plt.axis('off')
plt.savefig(os.path.join(cfg.outdir, 'inference_analysis', f'026_post_image_visualize_tiles_error.png'))
# plt.show();
plt.clf()
plt.close()
...
for it, mask in enumerate(masks):
    ...
    plt.title(uuid)
    plt.imshow(mask.numpy())
plt.savefig(os.path.join(cfg.outdir, 'inference_analysis', f'026_mask_visualize_tiles_error.png'))
# plt.show();
plt.clf()
plt.close()
...
plt.savefig(os.path.join(cfg.outdir, 'inference_analysis', f'026_mask-predict_visualize_tiles_error.png'))
# plt.show();
plt.clf()
plt.close()
...
for idx_band in range(12):    
    ...
    plt.savefig(os.path.join(cfg.outdir, 'inference_analysis', f'026_overlay_band{idx_band+1}_visualize_tiles_error.png'))
    plt.clf()
    plt.close()
